...
public enum Operations {
	...
	//l'attribut symbole representant le symbole de l'operation (+, -, …​)
	...
	// la methode abstraite eval retournant le résultat de l'evaluation de l'operation sur deux operande
